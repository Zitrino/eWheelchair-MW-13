...
// ############################ VARIANT_USART SETTINGS ############################
  ...
  #define PRI_INPUT1             2, 0, 511, 1023, 30     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2             2, 1023, 511, 0, 30     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
  ...
  #define SPEED_COEFFICIENT       32767    //  0.5f
  //#define STEER_COEFFICIENT       3277    //  0.25f
  #define STEER_COEFFICIENT       32767   // -0.2f 32767
  // #define SUPPORT_BUTTONS_LEFT       // use left sensor board cable for button inputs.  Disable DEBUG_SERIAL_USART2!
  // #define SUPPORT_BUTTONS_RIGHT      // use right sensor board cable for button inputs. Disable DEBUG_SERIAL_USART3!
